...
INSERT INTO `dscience` (`prefix`, `number`, `class`, `hours`, `availability`, `type`) VALUES
...
--
-- Table structure for table `isystems`
--

CREATE TABLE `isystems` (
  `prefix` varchar(5) NOT NULL,
  `number` int(4) NOT NULL,
  `class` varchar(50) NOT NULL,
  `hours` int(2) NOT NULL,
...
--
-- Dumping data for table `isystems`
--

INSERT INTO `isystems` (`prefix`, `number`, `class`, `hours`, `availability`, `type`) VALUES
('CSC', 114, 'Introduction to Computer Science', 3, 'S/F', 'CC'),
('CSC', 115, 'Programming I', 3, 'S/F', 'CC'),
('CSC', 160, 'Computer Science Major Orientation Seminar', 1, 'S/F', 'CC'),
('CSC', 215, 'Programming II', 3, 'S/F', 'CC'),
